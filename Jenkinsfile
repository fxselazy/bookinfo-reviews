...
"""
    ...
    PROJECT_KEY = "fuse-bookinfo-reviews"
    PROJECT_NAME = "fuse-bookinfo-reviews"
  }
            ...
            container('helm') {
                script {
                    ...
                    sh "helm template -f k8s/helm-values/values-bookinfo-${ENV_NAME}-reviews.yaml \
                        ...
                        --namespace fuse-bookinfo-${ENV_NAME} fuse-reviews-${ENV_NAME} k8s/helm \
        ...
        container('docker') {
          script {
            ...
            docker.withRegistry('https://ghcr.io', 'github-registry') {
              ...
              docker.build('ghcr.io/fxselazy/bookinfo-reviews:${ENV_NAME}').push()
        ...
        steps {
            container('jnlp') {
                script {
                    ...
                    writeFile file: 'anchore_images' , text: "ghcr.io/fxselazy/bookinfo-reviews:${ENV_NAME}"
